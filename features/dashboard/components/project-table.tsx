              ...
              <TableRow key={project.id}>
               <TableCell>
                 <div className="flex flex-col">
                  ...
                  <span className="text-sm text-foreground line-clamp-1">{project.description}</span>
                </div>
               </TableCell>
               <TableCell>
                  <Badge variant="outline" className="bg-[#48454515] text-[#fff] border-[#fff]">
                    {project.template}
                  </Badge>
                </TableCell>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Are you sure you want to delete <span className="text-semibold text-red-400">"{selectedProject?.title}"</span>This action cannot be undone. all files and data associated with this project will be permanently removed.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                    ...
                    disabled={isLoading}
                    className="bg-foreground text-destructive-foreground hover:bg-destructive/90"
                >
